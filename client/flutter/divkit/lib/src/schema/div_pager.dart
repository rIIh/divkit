  ...
  static DivPager? fromJson(
    ...
    try {
      return DivPager(
        ...
        layoutMode: reqProp<DivPagerLayoutMode>(
          safeParseObject(
            json['layout_mode'],
            parse: DivPagerLayoutMode.fromJson,
          ),
          name: 'layout_mode',
        ),
        ...
        orientation: reqVProp<DivPagerOrientation>(
        ...
        pageTransformation: safeParseObject(
          json['page_transformation'],
          parse: DivPageTransformation.fromJson,
        ),
...
enum DivPagerOrientation {
  ...
  static DivPagerOrientation? fromJson(
    ...
    try {
      ...
      logger.warning(
        "Invalid type of DivPagerOrientation: $json",
        error: e,
        stackTrace: st,
      );
      return null;
