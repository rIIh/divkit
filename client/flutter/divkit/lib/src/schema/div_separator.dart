...
class DivSeparator extends Preloadable with EquatableMixin implements DivBase {
  const DivSeparator({
  ...
  static Future<DivSeparator?> parse(
    Map<String, dynamic>? json,
  ) async {
    if (json == null) {
      return null;
    ...
    try {
      return DivSeparator(
        ...
        delimiterStyle: (await safeParseObjAsync(
          DivSeparatorDelimiterStyle.fromJson(json['delimiter_style']),
          fallback: const DivSeparatorDelimiterStyle(),
        ))!,
  ...
  Future<void> preload(
    ...
    try {
      ...
      await delimiterStyle.preload(context);
...
/// Separator display settings.
class DivSeparatorDelimiterStyle extends Preloadable with EquatableMixin {
  ...
  static Future<DivSeparatorDelimiterStyle?> parse(
    Map<String, dynamic>? json,
  ) async {
    if (json == null) {
      return null;
...
enum DivSeparatorDelimiterStyleOrientation implements Preloadable {
  vertical('vertical'),
  horizontal('horizontal');
  ...
  static DivSeparatorDelimiterStyleOrientation? fromJson(
    String? json,
  ) {
    if (json == null) {
      return null;
  ...
  static Future<DivSeparatorDelimiterStyleOrientation?> parse(
    String? json,
  ) async {
    if (json == null) {
      return null;
