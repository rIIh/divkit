  ...
  static DivSeparator? fromJson(
    ...
    try {
      return DivSeparator(
        ...
        delimiterStyle: reqProp<DivSeparatorDelimiterStyle>(
          safeParseObject(
            json['delimiter_style'],
            parse: DivSeparatorDelimiterStyle.fromJson,
            fallback: const DivSeparatorDelimiterStyle(),
          ),
          name: 'delimiter_style',
        ),
  ...
  static DivSeparatorDelimiterStyle? fromJson(
    ...
    try {
      return DivSeparatorDelimiterStyle(
        ...
        orientation: reqVProp<DivSeparatorDelimiterStyleOrientation>(
          safeParseStrEnumExpr(
            json['orientation'],
...
enum DivSeparatorDelimiterStyleOrientation {
  ...
  static DivSeparatorDelimiterStyleOrientation? fromJson(
    ...
    try {
      ...
      logger.warning(
        "Invalid type of DivSeparatorDelimiterStyleOrientation: $json",
        error: e,
        stackTrace: st,
      );
      return null;
